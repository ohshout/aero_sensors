...
uint8_t PIOS_SPI_TransferByte(struct pios_spi_dev *, uint8_t b);
...
*/
int32_t PIOS_SPI_TransferBlock(struct pios_spi_dev *, const uint8_t *send_buffer, uint8_t *receive_buffer, uint16_t len);
